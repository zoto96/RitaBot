In April of 2022 the code in this repo will be deprecated and we will no longer offer support for it!! For updated info on the future of the Ritabot-Project be sure to follow the [ANNOUNCEMENTS](https://discord.com/invite/v62WNej) channel in our Discord Server
...
<p align="center">Breaking the language barrier.</p>
<p align="center">RITA is now used on over 15000 Servers, by more than 1.5 Million Users.</p>
...
<p align="center">An open-source, Discord Translator Bot built using <strong>google-translate-api</strong> and <strong>Discord.js</strong>.</p>
